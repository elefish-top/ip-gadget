...
//定义背景
$im = imagecreatefromjpeg("./internet.jpg");
//定义颜色
...
$font = 'unifont.ttf';
//输出
imagettftext($im, 16, 0, 10, 47, $red, $font,'来自 '.$address.' 的访客');
imagettftext($im, 16, 0, 10, 79, $red, $font, ''.date('Y年n月j日').' 星期'.$weekarray[date("w")]);
//当前时间添加到图片
imagettftext($im, 16, 0, 10, 111, $red, $font,'IP:'.$ip.'');
//ip
imagettftext($im, 16, 0, 10, 147, $red, $font,'操作系统 '.$os.' ');
imagettftext($im, 16, 0, 10, 182, $red, $font,'    欢迎您访问网站');
imagettftext($im, 13, 0, 10, 207, $black, $font,$get);
ImageGif($im);
ImageDestroy($im);
